...
const ProductDefaultPage = () => {
  ...
  if (!user) {
    ...
    if (review.length === 0) {
      ...
      addReview({ review, rating, productId: product?._id });
    }
  };
  ...
  const handleReviewReplySubmit = () => {
    if (!replyCreationLoading) {
      if (reply === "") {
        ...
        addReplyInReview({ comment: reply, productId: product?._id, reviewId });
      }
    }
  };
              ...
              <div className="shop-details-content">
                ...
                <div className="quantity-color-area">
                  <div className="quantity-color">
                    ...
                    <QuantityCounter initialValue="1" />
                  </div>
                </div>
                                      ...
                                      <div className="author-img">
                                        <img
                                          src={
                                            ...
                                            "/assets/img/inner-page/comment-author1.png "
                                          }
                                      ...
                                      <div className="comment-content">
                                        <div className="author-post style-2">
                                          <div className="author-info">
                                            <h5>
                                              {review.user.name},{" "}
                                              <span style={{color: 'grey'}}>{format(review.updatedAt)}</span>
                                            </h5>
                                          </div>
                                          <ul className="rating">
                                            ...
                                            <div key={index} className="commentReply">
                                              ...
                                              <div className="replyContent">
                                                <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                                                  ...
                                                  , {' '}
                                                  <span style={{color: 'grey', fontSize: '15px', fontWeight: '300', letterSpacing: '1'}}>{format(reply.createdAt)}</span>
                                                </div>
                                                <p>{reply.comment}</p>
                                              </div>
                                            </div>
