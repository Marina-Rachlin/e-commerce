...
const ProductCard = ({ product }) => {
  ...
  //Adding(removing) to wishlist (client-side)
            ...
            <li className="wishlist">
              <button onClick={() => handleToggleWishlist(product)}>
                <svg
                  ...
                  height={18}
                  viewBox="0 0 18 18"
                  className={isProductInWishlist ? "heart-filled" : ""}
                >
                ...
                <div className="col-lg-6">
                  <div className="shop-details-content">
                    ...
                    <p>
                      ...
                      aliquam.Mauris nec justo vitae ante auctor tol euismod sit
                      amet Praesent commodo at massa eget suscipit. Utani vitae
                      enim velit.
                    </p>
                    <div className="price-area">
                      <p className="price">
