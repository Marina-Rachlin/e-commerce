                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img ">
                      <Link legacyBehavior href="/shop">
                        <a>
                        <img src="/assets/img/topselling/product-img-13.png" alt="" className="img1" />
                        </a>
                      </Link>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                        <img src="/assets/img/topselling/product-img-14.png" alt="" />
                        </a>
                      </Link>
                      <div className="cart-btn-area">
                        <div className="cart-btn">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                        <img src="/assets/img/topselling/product-img-16.png" alt="" />
                        </a>
                      </Link>
                      <div className="cart-btn-area">
                        <div className="cart-btn">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                      <a>
                        <img src="/assets/img/topselling/product-img-1.png" alt="" />
                      </a>
                      </Link>
                      <div className="cart-btn-area">
                        <div className="cart-btn">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                      <a>
                        <img src="/assets/img/topselling/product-img-2.png" alt="" />
                      </a>
                      </Link>
                      <div className="cart-btn-area">
                        <div className="cart-btn">
