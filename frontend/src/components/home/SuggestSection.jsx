                    ...
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                          <img src="/assets/img/suggest/new-product1.png" alt="" />
                          </a>
                        </Link>
                        ...
                        {/* add to wishlist  or view buttons */}
                  ...
                  <div className="col-lg-12 col-sm-6 col-6">
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                          <img src="/assets/img/suggest/new-product2.png" alt="" className="img1" />
                          </a>
                        </Link>
                        <div className="cart-btn-area">
                          <div className="cart-btn">
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                              <img src="/assets/img/banners/handCream.png" alt="" />
                              </a>
                            </Link>
                            <div className="view-and-favorite-area">
                              <ul>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                              <img src="/assets/img/banners/man-bossem1.png" alt="" />
                              </a>
                            </Link>
                            <div className="view-and-favorite-area">
                              <ul>
                      ...
                      <SwiperSlide className="swiper-slide">
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                              <img src="/assets/img/banners/man-bossem2.png" alt="" />
                              </a>
                            </Link>
                            <div className="view-and-favorite-area">
                              <ul>
                  ...
                  <div className="col-lg-12 col-sm-6 col-6">
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                          <img src="/assets/img/suggest/new-product3.png" alt="" className="img1" />
                          </a>
                        </Link>
                        <div className="cart-btn-area">
                          <div className="cart-btn">
                  ...
                  <div className="col-lg-12 col-sm-6">
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                          <img src="/assets/img/suggest/new-product4.png" alt="" />
                          </a>
                        </Link>
                        <div className="cart-btn-area">
                          <div className="cart-btn">
