          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-3.png" alt="" className="img1" />
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-4.png" alt="" />
                  </a>
                </Link>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-5.png" alt="" />
                  </a>
                </Link>
                <div className="cart-btn-area">
                  <div className="cart-btn">
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-6.png" alt="" className="img1" />
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-7.png" alt="" />
                  </a>
                </Link>
                <div className="cart-btn-area">
                  <div className="cart-btn">
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/products/product-img-8.png" alt="" className="img1" />
                  </a>
                </Link>
                <div className="cart-btn-area">
                  <div className="cart-btn">
