                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="product-banner-wrapper">
                      <div className="product-banner-left-img">
                        <img src="/assets/img/banners/product-banner-img1.png" alt="" />
                      </div>
                      <div className="product-banner-content"> 
                        <h2>Try fresh product for your face.</h2>
                        <Link legacyBehavior href="/shop/products"><a  className="primary-btn3 black-bg hover-btn5 hover-white">Shop Now</a></Link>
                      </div>
                      <div className="product-banner-right-img">
                        <img src="/assets/img/banners/product-banner-img2.png" alt="" />
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="product-banner-wrapper">
                      <div className="product-banner-left-img">
                        <img src="/assets/img/banners/product-banner-img4.png" alt="" />
                      </div>
                      <div className="product-banner-content"> 
                      ...
                      <div className="product-banner-right-img">
                        <img src="/assets/img/banners/product-banner-img3.png" alt="" />
                      </div>
                    </div>
                  </SwiperSlide>
                  <SwiperSlide className="swiper-slide">
                    <div className="product-banner-wrapper">
                      <div className="product-banner-left-img">
                        <img src="/assets/img/banners/product-banner-img5.png" alt="" />
                      </div>
                      <div className="product-banner-content"> 
                      ...
                      <div className="product-banner-right-img">
                        <img src="/assets/img/banners/product-banner-img6.png" alt="" />
                      </div>
                    </div>
                  </SwiperSlide>
                </div>
