            ...
            <div className="category-card style-2">
              <div className="category-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/categories/body.png" alt="" />
                  </a>
                </Link>
              </div>
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="category-card style-2">
              <div className="category-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/categories/skin.png" alt="" />
                  </a>
                </Link>
              </div>
              <div className="category-card-content">
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="category-card style-2">
              <div className="category-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/categories/hair.png" alt="" />
                  </a>
                </Link>
              </div>
              <div className="category-card-content">
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="category-card style-2">
              <div className="category-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/categories/makeup.png" alt="" />
                  </a>
                </Link>
              </div>
              <div className="category-card-content">
          ...
          <div className="col-lg-2 col-md-3 col-sm-4">
            <div className="category-card style-2">
              <div className="category-card-img">
                <Link legacyBehavior href="/shop">
                  <a>
                  <img src="/assets/img/categories/tools.png" alt="" />
                  </a>
                </Link>
              </div>
              <div className="category-card-content">
